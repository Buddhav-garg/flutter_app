...
import 'package:test_app/core/utils/money.dart';
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '${_from.maskedNumber} · Available ${formatRupees(_from.balanceInPaise)}',
              ...
              TextFormField(
                ...
                validator: (value) =>
                    Validators.amount(value, balancePaise: _from.balanceInPaise),
              ),
